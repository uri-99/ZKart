...
contract Contract is Ownable {
    ...
    uint16 public constant product_name_len = 3;
    uint16 public constant delivery_address_len = 3;
    constructor (IDKIMRegistry r, Verifier v) Ownable(msg.sender) {
        dkimRegistry = r;
        verifier = v;
    }
    function verify(uint[2] calldata a, uint[2][2] calldata b, uint[2] calldata c, uint[10] calldata signals) external view {
        // verify RSA
